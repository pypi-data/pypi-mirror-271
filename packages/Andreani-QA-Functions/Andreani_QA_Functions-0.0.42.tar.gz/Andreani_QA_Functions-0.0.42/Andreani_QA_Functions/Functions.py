...
class Functions(Parameters):
    ...
    def get_data_resource(self, key: str):
        ...
        if value is None:
            Andreani_QA_Selenium.logger.warning(f"{Functions.color_message('YELLOW', 'ADVERTENCIA:')} La clave {key} consultada no existe en el diccionario de resources.")
    ...
    def set_data_cache(self, key: str, value: Any):
        ...
        Andreani_QA_Selenium.logger.warning(f"{Functions.color_message('BLUE', 'Dato guardado en caché')}: key: {key} -> valor: {value}")
