...
class Functions(Parameters):
    ...
    def set_proyect(self, project_name=None):
        ...
        Andreani_QA_Selenium.Selenium.logger.warning(f"Plataforma {platform.system()} detectada.")
    ...
    def get_data_resource(self, key: str):
        ...
        if value is None:
            Andreani_QA_Selenium.Selenium.logger.warning(f"{Functions.color_message('YELLOW', 'ADVERTENCIA:')} La clave {key} consultada no existe en el diccionario de resources.")
    ...
    def set_data_cache(self, key: str, value: Any):
        ...
        Andreani_QA_Selenium.Selenium.logger.warning(f"{Functions.color_message('BLUE', 'Dato guardado en caché')}: key: {key} -> valor: {value}")
