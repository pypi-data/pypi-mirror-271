...
class CTD():
    ...
    _calculator = None
    _cwd = None
    master_sheet_path = "Fjord Phyto MASTERSHEET.xlsx"
    ...
    def run_complex_cleaner(self, feature, method='salinitydiff'):
        ...
        method : str
            The cleaning method to apply (default: 'salinitydiff').
        """
        if self.Utility.no_values_in_object(self._ctd_array):
            raise CTDError(self._filename, self._NO_SAMPLES_ERROR)
        supported_features = {
    ...
    def add_mean_surface_density(self):
        """
        ...
        if self.Utility.no_values_in_object(self._ctd_array):
            raise CTDError(self._filename, self._NO_SAMPLES_ERROR)
        mean_surface_density = Calculate.calculate_mean_surface_density(self._ctd_array.copy())
...
class Calculate:
    ...
    def calculate_mld(densities, depths, reference_depth):
        ...
        by a predefined amount (0.05 kg/m³).
    ...
    def calculate_mean_surface_density(df):
        ...
        -------
        float
            Mean density value of the entire sample.
        """
