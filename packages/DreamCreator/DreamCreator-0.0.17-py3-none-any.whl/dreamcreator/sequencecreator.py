...
class GUI(QWidget):
    ...
    def on_itembox4_checked(self):
        ...
        if len(checked_items) == 1:
            ...
            for i in range(self.listbox2.count()):
                ...
                a = item.text()
                b = checked_items[0].text()
                if checked_items[0].text() in self.devicedict[item.text()]['sequences']:
    ...
    def set_sequence(self, item):
        ...
        self.yamldict["Sequences"][self.sequence_namer.text() + "(" + self.sequence_name0 + ")"]['Runtime'] = runtime
