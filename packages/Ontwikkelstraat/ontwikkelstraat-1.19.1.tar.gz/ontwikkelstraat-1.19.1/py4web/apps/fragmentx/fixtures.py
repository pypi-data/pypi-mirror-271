...
class BaseTemplateSettings(Fixture):
    ...
    default_settings = dict(
        ...
        # item-specific page:
        map_zoom_level=10,  # 1 is the whole world, 20 is a few meters - Remco vindt level 10 een goed idee.
        # map_center="(52.150216,4.895168)",
        map_center="auto",  # Either a point, 'auto' or 'average'
        map_center_fallback="(52.150216,4.895168)",  # used if map_center is 'auto' and no point available
        map_zoom_level_fallback=7,  # used if map_center is 'auto' and no point available
    )
