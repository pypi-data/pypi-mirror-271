...
class SingleIndexPolicy():
    ...
    def __init__(self,
        ...
        self.S_e = 0.5 # initial value

        self.algorithm = algorithm
    
    def set_and_calculate_grid(self, S, S_e, step_size, plot=False):
        
        print(step_size)
        print(self.num_iterations_per_parameter)
        ...
        # cost_matrix = np.zeros((len(S_e_candidates), len(S_candidates)))
