...
from wgse.alignment_map.alignment_map_row import (AlignmentMapFlag,
                                                  AlignmentMapRow)
from wgse.configuration import ALIGNMENT_STATS_CFG, AlignmentStatsConfig
...
class AlignmentStatsCalculator:
    def __init__(
        ...
        config: AlignmentStatsConfig = ALIGNMENT_STATS_CFG,
    ...
    def _read_samples(self, skip, samples_count):
        options = []
        # if self.aligned_file.file_type == AlignmentMapFileType.CRAM:
        #     options.extend(["-T", self.aligned_file.reference_genome])
