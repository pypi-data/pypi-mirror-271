...
from wgse.configuration import REPOSITORY_CFG, RepositoryConfig
...
class MicroarrayConverter:
    def __init__(self, config: RepositoryConfig = REPOSITORY_CFG) -> None:
        self._config = config
    ...
    def ingest(self, target: MicroarrayConverterTarget):
        ...
        with body_path.with_name(body_path.stem + "_fix").open("wt") as file:
