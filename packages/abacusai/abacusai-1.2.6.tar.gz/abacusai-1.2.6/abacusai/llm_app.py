...
class LlmApp(AbstractApiClass):
    ...
    def __init__(self, client, llmAppId=None, name=None, description=None, deploymentId=None, createdAt=None, updatedAt=None):
    ...
    def __repr__(self):
        repr_dict = {f'llm_app_id': repr(self.llm_app_id), f'name': repr(self.name), f'description': repr(
            self.description), f'deployment_id': repr(self.deployment_id), f'created_at': repr(self.created_at), f'updated_at': repr(self.updated_at)}
        class_name = "LlmApp"
    ...
    def to_dict(self):
        ...
        """
        resp = {'llm_app_id': self.llm_app_id, 'name': self.name, 'description': self.description,
                'deployment_id': self.deployment_id, 'created_at': self.created_at, 'updated_at': self.updated_at}
