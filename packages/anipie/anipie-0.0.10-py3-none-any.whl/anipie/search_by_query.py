...
class SearchByQuery:
    ...
    def get_start_date(self) -> str:
        ...
        if any(
            value is None
            for value in (esd.get("month"), esd.get("day"), esd.get("year"))
        ):
            return None
        return (
            str(esd.get("month") or "")
            + "/"
            + str(esd.get("day") or "")
            + "/"
            + str(esd.get("year") or "")
    ...
    def get_end_date(self) -> str:
        ...
        if any(
            value is None
            for value in (exp.get("month"), exp.get("day"), exp.get("year"))
        ):
            return None
        return (
            str(exp.get("month") or "")
            + "/"
            + str(exp.get("day") or "")
            + "/"
            + str(exp.get("year") or "")
    ...
    def get_chapters(self) -> int:
        ...
        if self._media.get("chapters") is None:
            return 0
    ...
    def get_volumes(self) -> int:
        ...
        if self._media.get("volumes") is None:
            return 0
