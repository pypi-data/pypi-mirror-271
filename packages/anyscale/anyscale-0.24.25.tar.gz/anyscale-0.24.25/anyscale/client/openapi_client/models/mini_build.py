...
class MiniBuild(object):
    ...
    def __init__(self, id=None, revision=None, status=None, application_template_name=None, application_template_id=None, local_vars_configuration=None):  # noqa: E501
