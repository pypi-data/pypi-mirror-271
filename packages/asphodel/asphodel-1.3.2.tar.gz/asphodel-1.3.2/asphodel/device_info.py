...
class ActiveScanInfo:
    ...
    @classmethod
    def from_dict(cls, device_info: dict[str, Any]):
        return cls(**{
...
class Incrementer:
    ...
    def increment(self, difference: int, section_name: str):
    ...
    def set_values(self, finished: int, total: int):
...
def get_device_info_dict(
    ...
    if not serial_number:
        raise Exception("No serial number when fetching device info")
