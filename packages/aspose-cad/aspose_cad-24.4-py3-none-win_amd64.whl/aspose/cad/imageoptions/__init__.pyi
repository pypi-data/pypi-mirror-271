...
class DwgConvertOptions(DwgOptionsBase):
...
class DwgOptionsBase(ImageOptionsBase):
...
class DwgRenderOptions(DwgOptionsBase):
...
class DxfConvertOptions(DxfOptionsBase):
...
class DxfOptionsBase(ImageOptionsBase):
...
class DxfRenderOptions(DxfOptionsBase):
