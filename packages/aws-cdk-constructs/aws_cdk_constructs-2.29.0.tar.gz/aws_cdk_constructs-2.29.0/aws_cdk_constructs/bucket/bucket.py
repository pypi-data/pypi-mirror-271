...
class Bucket(Construct):
    ...
    def update_distribution_origin_access(self):
        ...
        all_distribution_props = self._cloudfront_distribution.node.find_all()
        ...
        distribution_props = self._cloudfront_distribution.node.default_child
        ...
        origins_amount = len(self._cloudfront_distribution.node.children) - 1
