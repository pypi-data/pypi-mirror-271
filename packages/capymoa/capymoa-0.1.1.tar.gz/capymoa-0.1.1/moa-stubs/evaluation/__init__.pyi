...
class EfficientEvaluationLoops:
    def __init__(self): ...
    @staticmethod
    def PrequentialEvaluation(exampleStream: moa.streams.ExampleStream, learner: moa.learners.Learner, learningPerformanceEvaluator: 'LearningPerformanceEvaluator', learningPerformanceEvaluator2: 'LearningPerformanceEvaluator', long: int, long2: int) -> 'EfficientEvaluationLoops.PrequentialResult': ...
    @staticmethod
