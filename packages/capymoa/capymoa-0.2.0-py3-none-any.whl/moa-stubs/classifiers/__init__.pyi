...
class AbstractParallelClassifierMiniBatch(AbstractClassifier, Classifier, moa.capabilities.CapabilitiesHandler):
...
class __module_protocol__(Protocol):
    ...
    AbstractParallelClassifierMiniBatch: typing.Type[AbstractParallelClassifierMiniBatch]
