...
class DataHcpIamPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param bindings: A binding associates a set of principals to a role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.88.0/docs/data-sources/iam_policy#bindings DataHcpIamPolicy#bindings}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataHcpIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcp/0.88.0/docs/data-sources/iam_policy#import import section} in the documentation of this resource for the id to use
...
class DataHcpIamPolicyBindings:
    def __init__(
        ...
        *,
        ...
        '''
        :param principals: The set of principals to bind to the given role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.88.0/docs/data-sources/iam_policy#principals DataHcpIamPolicy#principals}
        :param role: The role name to bind to the given principals. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/hcp/0.88.0/docs/data-sources/iam_policy#role DataHcpIamPolicy#role}
        '''
        if __debug__:
