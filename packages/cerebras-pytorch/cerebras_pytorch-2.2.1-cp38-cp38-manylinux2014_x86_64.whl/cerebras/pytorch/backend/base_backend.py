...
class BaseBackend(ABC, ClassLogger):
    ...
    def __init__(self, backend_type: BackendType, device: Device):
        ...
        self.sparsity_registry = []

        # We reset it on every setup_grad_scaler call
        ...
        # We reset it on every setup_model call
    ...
    def setup_sparsity(self, sparsity):
        self.sparsity_registry.append(sparsity)
    ...
    def _update_dataloader_state(self):
        ...
        The dataloader state is only available at checkpoint_steps. At all other steps,
