...
def _default_expect_feedback() -> DefaultExpectFeedback:
    ...
    return DefaultExpectFeedback(
        positive=lambda inp:
        f'Got expected {inp.what} {inp.get_expected_repr(False)}',
        negative=mk_negative,
    )
...
def _default_not_expect_feedback() -> DefaultExpectFeedback:
    def mk_negative(inp: ExpectFeedbackMakerInput) -> Feedback:
        return (
            f'Expected {inp.what} not to be'
            f' {inp.get_expected_repr(True)}'
        )
    ...
    return DefaultExpectFeedback(
        positive=lambda inp:
        f'Did not get disallowed {inp.what} {inp.get_expected_repr(False)}',
        negative=mk_negative,
    )
...
def _default_exist_feedback() -> DefaultExistFeedback:
    def mk_negative(inp: ExistFeedbackMakerInput) -> Feedback:
        return (
            f'Expected {inp.what} {inp.get_expected_repr(False)}'
            ' to exist'
        )
    ...
    return DefaultExistFeedback(
        positive=lambda inp:
        f'Found expected {inp.what} {inp.get_expected_repr(False)}',
        negative=mk_negative,
    )
...
def _default_not_exist_feedback() -> DefaultExistFeedback:
    def mk_negative(inp: ExistFeedbackMakerInput) -> Feedback:
        return (
            f'Expected {inp.what} {inp.get_expected_repr(True)} to not'
            ' exist'
        )
    ...
    return DefaultExistFeedback(
        positive=lambda inp:
        f'Did not find disallowed {inp.what} {inp.get_expected_repr(False)}',
        negative=mk_negative,
    )
