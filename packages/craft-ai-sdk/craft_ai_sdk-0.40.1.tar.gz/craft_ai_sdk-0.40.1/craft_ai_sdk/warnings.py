...
UPDATE_STEP_DEPRECATION_WARNING_MESSAGE = (
    "   .. deprecated:: 0.39.2\n"
    "       This function is deprecated and its usage is not supported.\n\n"
    "       Prefer to delete the step and re-create a new one."
)
...
def documentation_function_warning_decorator(
...
def experimental(func_or_message):
    ...
    return documentation_function_warning_decorator(
