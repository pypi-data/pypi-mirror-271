...
from deepstack import ComponentError, DeserializationError, Document, component, default_from_dict, default_to_dict
...
class NamedEntityExtractor:
    ...
    from deepstack.components.extractors.named_entity_extractor import NamedEntityExtractor
