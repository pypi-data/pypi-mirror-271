...
from deepstack import default_from_dict, default_to_dict, logging
...
class AzureOpenAIChatGenerator(OpenAIChatGenerator):
    ...
    Input and Output Format:
     ...
     - Details on the ChatMessage format can be found [here](https://docs.deepstack.khulnasoft.com/v2.0/docs/data-classes#chatmessage).


    Usage example:

    ```python
    from deepstack.components.generators.chat import AzureOpenAIGenerator
