...
from deepstack.utils.hf import HFModelType, check_generation_params, check_valid_model, list_inference_deployed_models
...
class HuggingFaceTGIChatGenerator:
    ...
    Input and Output Format:
      - ChatMessage Format: This component uses the ChatMessage format to structure both input and output,
        ...
        ChatMessage format can be found [here](https://docs.deepstack.khulnasoft.com/v2.0/docs/data-classes#chatmessage).
    ...
    def __init__(
        ...
        """
        warnings.warn(
            "`HuggingFaceTGIChatGenerator` is deprecated and will be removed in Deepstack 2.3.0."
