...
class Sockets:
    ...
    from deepstack.core.component.sockets import Sockets
    ...
    inputs.question
    >>> InputSocket(name='question', type=typing.Any, default_value=<class 'deepstack.core.component.types._empty'>, is_variadic=False, senders=[])
    ```
    """
    ...
    def _component_name(self) -> str:
        if pipeline := getattr(self._component, "__deepstack_added_to_pipeline__"):
