...
from deepstack.utils.type_serialization import deserialize_type
...
# It is now deprecated and will be removed in Deepstack 2.3.0.
...
class PyPDFToDocument:
    ...
    def __init__(self, converter_name: Optional[str] = None, converter: Optional[PyPDFConverter] = None):
        ...
        if converter_name:
            warnings.warn(
                "The `converter_name` parameter is deprecated and will be removed in Deepstack 2.3.0. "
