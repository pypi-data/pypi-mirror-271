...
from deepstack.utils.hf import HFGenerationAPIType, HFModelType, check_valid_model
...
class HuggingFaceAPIChatGenerator:
    ...
    Input and Output Format:
      - ChatMessage Format: This component uses the ChatMessage format to structure both input and output,
        ...
        ChatMessage format can be found [here](https://docs.deepstack.khulnasoft.com/docs/data-classes#chatmessage).
