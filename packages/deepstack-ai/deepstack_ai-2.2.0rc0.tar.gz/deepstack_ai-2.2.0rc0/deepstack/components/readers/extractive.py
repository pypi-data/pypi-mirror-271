...
from deepstack import ComponentError, Document, ExtractedAnswer, component, default_from_dict, default_to_dict, logging
from deepstack.lazy_imports import LazyImport
from deepstack.utils import ComponentDevice, DeviceMap, Secret, deserialize_secrets_inplace
from deepstack.utils.hf import deserialize_hf_model_kwargs, resolve_hf_device_map, serialize_hf_model_kwargs
...
class ExtractiveReader:
    ...
    def __init__(
        self,
        model: Union[Path, str] = "khulnasoft/roberta-base-squad2-distilled",
