...
class MetadataRouter:
    ...
    from deepstack.components.routers import MetadataRouter
    ...
    def __init__(self, rules: Dict[str, Dict]):
        ...
        :param rules: A dictionary of rules that specify which output connection to route a document to based on its metadata.
            ...
            follow the [format of filtering expressions in Deepstack](https://docs.deepstack.khulnasoft.com/v2.0/docs/metadata-filtering).
            For example:
            ```python
            {
            "edge_1": {
