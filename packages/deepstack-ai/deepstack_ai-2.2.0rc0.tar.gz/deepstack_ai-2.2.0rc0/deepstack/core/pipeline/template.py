...
class PipelineTemplate:
    ...
    - **Default Build**: Instantiating a pipeline with default settings for a "question answering" (qa) task.
      ```python
      from deepstack.templates import PipelineTemplate, PredefinedPipeline
    ...
    def __init__(self, template_content: str):
        ...
        """
        env = Environment(
            loader=PackageLoader("deepstack.core.pipeline", "predefined"), trim_blocks=True, lstrip_blocks=True
        )
        try:
