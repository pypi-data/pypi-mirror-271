...
from deepstack.version import __version__
...
def collect_system_specs() -> Dict[str, Any]:
    """
    Collects meta-data about the setup that is used with Deepstack.

    Data collected includes: operating system, python version, Deepstack version, transformers version,
    ...
    """
    specs = {
        "libraries.deepstack": __version__,
