...
class DillWaveLearner:
  ...
  def save_to_checkpoint(self, epoch):
      save_name = f'{self.model_dir}/weights_epoch_{epoch}.pt'
      torch.save(self.state_dict(), save_name)
      # Remove oldest checkpoint after 5 saves
      checkpoints = sorted(glob.glob(f'{self.model_dir}/weights_epoch_*.pt'))
