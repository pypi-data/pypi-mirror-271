...
class AttributeNode:
    ...
    @property
    def value(self) -> Union[ObjectNode, ReferenceNode, NumericExpressionNode, StringExpressionNode, ListNode, DictNode, bool, int, float, str]: ...
...
class ListNode:
    ...
    @property
    def items(self) -> list[Union[ObjectNode, ReferenceNode, NumericExpressionNode, StringExpressionNode, ListNode, DictNode, bool, int, float, str]]: ...
...
class Profile:
    ...
    def line_info(self, info: Union[ObjectNode, ReferenceNode, NumericExpressionNode, StringExpressionNode, ListNode, DictNode, SourceInfo]) -> LineRange:
    ...
    def to_updated_source(self, values: Mapping[str, Union[int, float, str, bool]]) -> str:
...
class StringExpressionNode:
    ...
    @property
    def fragments(self) -> list[Union[str, ReferenceNode]]: ...
