...
def test_scan_sys_path(
    ...
    monkeypatch.setenv("DISTRONODE_COLLECTIONS_SCAN_SYS_PATH", str(param.scan))
    # Set the distronode collections paths to avoid bleed from other tests
    monkeypatch.setenv("DISTRONODE_COLLECTIONS_PATH", str(tmp_path))
