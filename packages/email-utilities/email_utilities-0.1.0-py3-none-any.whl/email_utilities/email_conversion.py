...
class EmailConversion:
    ...
    def load_email(self, file_location: str | Path = None) -> Any:
        """
    ...
    def _convert_html_to_plain_text(self, email_text: Any = None) -> str:
        """
    ...
    def convert_email_to_text(self, email_text: Any = None) -> Any | str:
        """
