...
# rsync -r ../build/exe.win-amd64-3.11/lib/emid/prm_files/ ../build/exe.win-amd64-3.11/prm_files/


wine cmd /c "Z:\media\ntfsShared\lin_home\auditory\code\emid\prep-release\win_launch_iss_compiler.bat"
