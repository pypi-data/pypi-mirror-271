...
STYLE_TARGET_SIMILARITY="style_target_similarity"
STYLE_CONSISTENCY="style_consistency"
CONTENT_TARGET_CONSISTENCY="content_target_consistency"
...
METRIC_LIST=[PROMPT_SIMILARITY, IDENTITY_CONSISTENCY, TARGET_SIMILARITY, AESTHETIC_SCORE, IMAGE_REWARD,
    ...
    STYLE_TARGET_SIMILARITY, STYLE_CONSISTENCY,
    CONTENT_TARGET_CONSISTENCY,CONTENT_CONSISTENCY]