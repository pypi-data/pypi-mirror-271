...
D1 = {"a": {"aa": 0, "ab": {"aba": 10, "abb": 11}, "ac": 0.2}, "b": [1], "c": 2}

D2 = {"a": {"ab": {"abb": None}}, "b": "newb"}

D = {"a": {"aa": 0, "ab": {"aba": 10, "abb": None}, "ac": 0.2}, "b": "newb", "c": 2}
...
_gi1 = {
    "news": {"twitter": {"filter": ["CrownPlatform"]}},
    "reddit": {},
    "forward_to": "Crypto",
}
_gi2 = {"twitter": {"filter": ["_keep_", "BlockThisGuy"]}}
_gi = {
    "news": {"twitter": {"filter": ["CrownPlatform", "BlockThisGuy"]}},
    "reddit": {},
    "forward_to": "Crypto",
}
