...
class ModelParams(BaseModel):
    ...
    max_tokens: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Maximum number of tokens to generate. The higher the value, the more random the output. The total length of input tokens and generated tokens is limited by the model's context length. Zero value means max possible number of tokens.")
