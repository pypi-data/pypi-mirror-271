    ...
    def make_instance(self, include_optional) -> ChatCompletionRequest:
        ...
        if include_optional:
            return ChatCompletionRequest(
                ...
                rag_config = openapi_client.models.rag_config.RAGConfig(
                    document_properties = {"organization":["hitachi-rail"],"document_class":["manual","user-manual"],"language":["english"],"content_type":["schematics"]}, ),
                prompt_config = openapi_client.models.prompt_config.PromptConfig(
                    template_id = '', 
                    input_variables = {"speciality":"computer engineer","age":"34"}, ),
                model_settings = openapi_client.models.model_settings.ModelSettings(
                    model = 'hitachi-genai-platform/HGP-7b-instruct', 
                    params = openapi_client.models.model_params.ModelParams(
                        temperature = 0.9, 
                        top_p = 0.1, 
                        max_tokens = 100, 
                        stop = ["stop","\\n","user:"], ), )
