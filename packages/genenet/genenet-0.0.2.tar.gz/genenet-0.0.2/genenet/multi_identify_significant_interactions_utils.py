...
def multi_identify_significant_interactions(n_bootstrap, quantile_threshold,gene_interaction_distance_intra_asc,random_seed=None):
...
#去除线性距离基因对
def multi_remove_distance(significant_gene_pairs,rm_distance):
