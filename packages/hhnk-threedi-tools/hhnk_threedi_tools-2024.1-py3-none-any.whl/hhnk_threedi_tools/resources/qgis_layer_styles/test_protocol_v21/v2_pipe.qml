...
<qgis readOnly="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.16.11-Hannover" maxScale="0">
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="pipe_quality"/>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="dist_calc_points"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="profile_num"/>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="sewerage_type"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="original_length"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="invert_level_end_point"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="2" constraints="1" field="invert_level_start_point"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="pipe_quality"/>
    ...
    <constraint desc="" exp="" field="profile_num"/>
    ...
    <constraint desc="" exp="" field="original_length"/>
    <constraint desc="" exp="" field="invert_level_end_point"/>
    <constraint desc="" exp="" field="invert_level_start_point"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="1" visibilityExpressionEnabled="0" name="Pipe" visibilityExpression="" groupBox="0" showLabel="1">
      <attributeEditorContainer columnCount="1" visibilityExpressionEnabled="0" name="General" visibilityExpression="" groupBox="1" showLabel="1">
        <attributeEditorField name="id" showLabel="1" index="17"/>
        <attributeEditorField name="display_name" showLabel="1" index="3"/>
        <attributeEditorField name="code" showLabel="1" index="2"/>
        <attributeEditorField name="calculation_type" showLabel="1" index="13"/>
      ...
      <attributeEditorContainer columnCount="1" visibilityExpressionEnabled="0" name="Characteristics" visibilityExpression="" groupBox="1" showLabel="1">
        <attributeEditorField name="invert_level_start_point" showLabel="1" index="12"/>
        <attributeEditorField name="invert_level_end_point" showLabel="1" index="11"/>
        <attributeEditorField name="friction_value" showLabel="1" index="15"/>
        <attributeEditorField name="friction_type" showLabel="1" index="14"/>
        <attributeEditorField name="cross_section_definition_id" showLabel="1" index="16"/>
      ...
      <attributeEditorContainer columnCount="1" visibilityExpressionEnabled="0" name="visualization" visibilityExpression="" groupBox="1" showLabel="1">
        <attributeEditorField name="sewerage_type" showLabel="1" index="9"/>
