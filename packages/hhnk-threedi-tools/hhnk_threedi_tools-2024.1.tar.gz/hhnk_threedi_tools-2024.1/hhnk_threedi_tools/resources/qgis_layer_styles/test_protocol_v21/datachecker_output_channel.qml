...
<qgis simplifyLocal="1" readOnly="0" labelsEnabled="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{9ead0fd9-1524-48bd-86fc-cc1267ce3401}">
      <rule symbol="0" key="{8d6874d3-b42e-4993-a331-9389607e556b}" checkstate="0" label="Channel datachecker"/>
      <rule symbol="1" key="{a47c02b6-2d84-40d0-ae1a-0f27aa4e582a}" checkstate="0" label="dummy" filter=" &quot;id&quot; =-1"/>
    </rules>
    <symbols>
      <symbol type="line" name="0" alpha="1" clip_to_extent="1" force_rhr="0">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop v="4,255,4,255" k="line_color"/>
      ...
      <symbol type="line" name="1" alpha="1" clip_to_extent="1" force_rhr="0">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="141,51,74,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
  ...
  <fieldConfiguration>
    ...
    <field name="talud_left" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="talud_right" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="tabulated_width" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="tabulated_height" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="derived_bed_level" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="profile_valid" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
    ...
    <field name="profile_type" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="QString" name="IsMultiline" value="0"/>
  ...
  <aliases>
    ...
    <alias name="" index="6" field="bed_level"/>
    <alias name="" index="7" field="comment"/>
    <alias name="" index="8" field="name"/>
    <alias name="" index="9" field="talud_left"/>
    <alias name="" index="10" field="talud_right"/>
    <alias name="" index="11" field="image_url"/>
    <alias name="" index="12" field="channel_type_id"/>
    <alias name="" index="13" field="bed_width"/>
    <alias name="" index="14" field="tabulated_width"/>
    <alias name="" index="15" field="tabulated_height"/>
    <alias name="" index="16" field="derived_bed_level"/>
    <alias name="" index="17" field="profile_valid"/>
    <alias name="" index="18" field="profile_type"/>
    <alias name="" index="19" field="typering"/>
    <alias name="" index="20" field="aanname"/>
    <alias name="" index="21" field="hasassumption"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="talud_left"/>
    <default expression="" applyOnUpdate="0" field="talud_right"/>
    ...
    <default expression="" applyOnUpdate="0" field="tabulated_width"/>
    <default expression="" applyOnUpdate="0" field="tabulated_height"/>
    <default expression="" applyOnUpdate="0" field="derived_bed_level"/>
    <default expression="" applyOnUpdate="0" field="profile_valid"/>
    <default expression="" applyOnUpdate="0" field="profile_type"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="talud_left"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="talud_right"/>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="tabulated_width"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="tabulated_height"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="derived_bed_level"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="profile_valid"/>
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="profile_type"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="talud_left"/>
    <constraint desc="" exp="" field="talud_right"/>
    <constraint desc="" exp="" field="image_url"/>
    <constraint desc="" exp="" field="channel_type_id"/>
    <constraint desc="" exp="" field="bed_width"/>
    <constraint desc="" exp="" field="tabulated_width"/>
    <constraint desc="" exp="" field="tabulated_height"/>
    <constraint desc="" exp="" field="derived_bed_level"/>
    <constraint desc="" exp="" field="profile_valid"/>
    <constraint desc="" exp="" field="profile_type"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="talud_left" hidden="0"/>
      <column width="-1" type="field" name="talud_right" hidden="0"/>
      ...
      <column width="-1" type="field" name="width_at_waterlevel" hidden="0"/>
