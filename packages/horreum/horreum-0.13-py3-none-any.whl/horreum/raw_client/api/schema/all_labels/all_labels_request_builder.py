...
class AllLabelsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[List[LabelInfo]]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AllLabelsRequestBuilder:
        """
