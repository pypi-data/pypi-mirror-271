...
class WithLabelItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/schema/{id-id}/labels/{labelId}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/schema/{id%2Did}/labels/{labelId}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> WithLabelItemRequestBuilder:
        """
