...
class Cost_OptionsDT(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, setup, mesh, njoc, njrc, handle=None):
        ...
        result = _libfcore.f90wrap_cost_optionsdt_initialise(setup=setup._handle, \
    ...
    def __del__(self):
        ...
        try:
            if self._alloc:
                _libfcore.f90wrap_cost_optionsdt_finalise(this=self._handle)
        except:
            pass
...
def cost_optionsdt_copy(self):
    ...
    """
    this_copy = _libfcore.f90wrap_cost_optionsdt_copy(this=self._handle)
    this_copy = \
...
def cost_optionsdt_alloc_control_prior(self, n, npar):
    ...
    """
    _libfcore.f90wrap_cost_optionsdt_alloc_control_prior(this=self._handle, n=n, \
        npar=npar)
