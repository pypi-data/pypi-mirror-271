...
def nse(x, y):
    ...
    only: sp
    """
    res = _libfcore.f90wrap_nse(x=x, y=y)
    return res
...
def nnse(x, y):
    ...
    NSE = 1 / (2 - NSE)
    """
    res = _libfcore.f90wrap_nnse(x=x, y=y)
    return res
...
def kge_components(x, y, r, a, b):
    ...
    b = std(y) / std(x)
    """
    _libfcore.f90wrap_kge_components(x=x, y=y, r=r, a=a, b=b)
...
def kge(x, y):
    ...
    kge_components
    """
    res = _libfcore.f90wrap_kge(x=x, y=y)
    return res
...
def mae(x, y):
    ...
    MAE = sum(abs(x - y)) / n
    """
    res = _libfcore.f90wrap_mae(x=x, y=y)
    return res
...
def mape(x, y):
    ...
    """
    res = _libfcore.f90wrap_mape(x=x, y=y)
    return res
...
def se(x, y):
    ...
    SE = sum((x - y) ** 2)
    """
    res = _libfcore.f90wrap_se(x=x, y=y)
    return res
...
def mse(x, y):
    ...
    se
    """
    res = _libfcore.f90wrap_mse(x=x, y=y)
    return res
...
def rmse(x, y):
    ...
    mse
    """
    res = _libfcore.f90wrap_rmse(x=x, y=y)
    return res
...
def lgrm(x, y):
    ...
    """
    res = _libfcore.f90wrap_lgrm(x=x, y=y)
    return res
