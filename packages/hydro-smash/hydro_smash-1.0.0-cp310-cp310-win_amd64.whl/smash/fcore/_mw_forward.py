...
def forward_run(self, mesh, input_data, parameters, output, options, returns):
    ...
    """
    _libfcore.f90wrap_forward_run(setup=self._handle, mesh=mesh._handle, \
...
def forward_run_d(self, mesh, input_data, parameters, parameters_d, output, \
    ...
    """
    _libfcore.f90wrap_forward_run_d(setup=self._handle, mesh=mesh._handle, \
        input_data=input_data._handle, parameters=parameters._handle, \
        parameters_d=parameters_d._handle, output=output._handle, \
        output_d=output_d._handle, options=options._handle, returns=returns._handle)
...
def forward_run_b(self, mesh, input_data, parameters, parameters_b, output, \
    ...
    """
    _libfcore.f90wrap_forward_run_b(setup=self._handle, mesh=mesh._handle, \
        input_data=input_data._handle, parameters=parameters._handle, \
        parameters_b=parameters_b._handle, output=output._handle, \
        output_b=output_b._handle, options=options._handle, returns=returns._handle)
...
def multiple_forward_run_sample_to_parameters(sample, samples_kind, samples_ind, \
    ...
    """
    _libfcore.f90wrap_multiple_forward_run_sample_to_parameters(sample=sample, \
...
def multiple_forward_run(self, mesh, input_data, parameters, output, options, \
    ...
    """
    _libfcore.f90wrap_multiple_forward_run(setup=self._handle, mesh=mesh._handle, \
        input_data=input_data._handle, parameters=parameters._handle, \
        output=output._handle, options=options._handle, samples=samples, \
        samples_kind=samples_kind, samples_ind=samples_ind, cost=cost, q=q)
