...
class Sparse_MatrixDT(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, n, coo_fmt, zvalue, handle=None):
        ...
        result = _libfcore.f90wrap_sparse_matrixdt_initialise(n=n, coo_fmt=coo_fmt, \
            zvalue=zvalue)
    ...
    def __del__(self):
        ...
        try:
            if self._alloc:
                _libfcore.f90wrap_sparse_matrixdt_finalise(this=self._handle)
        except:
            pass
...
def sparse_matrixdt_alloc(self, n, coo_fmt, zvalue):
    ...
    """
    _libfcore.f90wrap_sparse_matrixdt_alloc(this=self._handle, n=n, coo_fmt=coo_fmt, \
        zvalue=zvalue)
...
def sparse_matrixdt_copy(self, this_copy):
    ...
    """
    _libfcore.f90wrap_sparse_matrixdt_copy(this=self._handle, \
