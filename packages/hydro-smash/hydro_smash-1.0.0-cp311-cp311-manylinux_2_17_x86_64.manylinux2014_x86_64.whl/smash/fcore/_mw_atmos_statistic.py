...
def get_mean_gauge_atmos_data(self, mask_gauge, mask_atmos, mat_atmos, \
    ...
    """
    _libfcore.f90wrap_get_mean_gauge_atmos_data(mesh=self._handle, \
...
def compute_mean_atmos(self, mesh, input_data):
    ...
    """
    _libfcore.f90wrap_compute_mean_atmos(setup=self._handle, mesh=mesh._handle, \
...
def compute_prcp_partitioning(self, mesh, input_data):
    ...
    """
    _libfcore.f90wrap_compute_prcp_partitioning(setup=self._handle, \
