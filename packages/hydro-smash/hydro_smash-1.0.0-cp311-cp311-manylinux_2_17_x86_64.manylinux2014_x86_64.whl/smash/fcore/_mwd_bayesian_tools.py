...
class PriorType(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, n, handle=None):
        ...
        result = _libfcore.f90wrap_priortype_initialise(n=n)
    ...
    def __del__(self):
        ...
        try:
            if self._alloc:
                _libfcore.f90wrap_priortype_finalise(this=self._handle)
        except:
            pass
...
def compute_loglkh(obs, uobs, sim, mu_funk, mu_gamma, sigma_funk, sigma_gamma):
    ...
    """
    loglkh, feas, isnull = _libfcore.f90wrap_compute_loglkh(obs=obs, uobs=uobs, \
...
def compute_logh():
    ...
    """
    logh, feas, isnull = _libfcore.f90wrap_compute_logh()
...
def getparnumber(distid):
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    """
    npar, err, mess = _libfcore.f90wrap_getparnumber(distid=distid)
...
def getparname(distid, name):
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    """
    err, mess = _libfcore.f90wrap_getparname(distid=distid, name=name)
    return err, mess
...
def checkparsize(distid, par):
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    """
    ok, err, mess = _libfcore.f90wrap_checkparsize(distid=distid, par=par)
    return ok, err, mess
...
def getparfeas(distid, par):
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    """
    feas, err, mess = _libfcore.f90wrap_getparfeas(distid=distid, par=par)
...
def getpdf(distid, x, par, loga):
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    """
    pdf, feas, isnull, err, mess = _libfcore.f90wrap_getpdf(distid=distid, x=x, \
        par=par, loga=loga)
...
def sigmafunk_apply(funk, par, y):
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    """
    res, err, mess = _libfcore.f90wrap_sigmafunk_apply(funk=funk, par=par, y=y)
    return res, err, mess
...
def mufunk_apply(funk, par, y):
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    """
    res, err, mess = _libfcore.f90wrap_mufunk_apply(funk=funk, par=par, y=y)
    return res, err, mess
...
def sigmafunk_vect(funk, par, y, res):
    ...
    """
    _libfcore.f90wrap_sigmafunk_vect(funk=funk, par=par, y=y, res=res)
...
def mufunk_vect(funk, par, y, res):
    ...
    """
    _libfcore.f90wrap_mufunk_vect(funk=funk, par=par, y=y, res=res)
