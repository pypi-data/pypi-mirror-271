...
Defined at ../smash/fcore/derived_type/mwd_setup.f90 lines 65-138
...
class SetupDT(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at ../smash/fcore/derived_type/mwd_setup.f90 lines 68-120
    ...
    def __init__(self, nd, handle=None):
        ...
        Defined at ../smash/fcore/derived_type/mwd_setup.f90 lines 123-132
        ...
        result = _libfcore.f90wrap_setupdt_initialise(nd=nd)
    ...
    def __del__(self):
        ...
        try:
            if self._alloc:
                _libfcore.f90wrap_setupdt_finalise(this=self._handle)
        except:
            pass
    ...
    def snow_module(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_setup.f90 line 73
    ...
    def hydrological_module(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_setup.f90 line 74
    ...
    def routing_module(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_setup.f90 line 75
    ...
    def serr_mu_mapping(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_setup.f90 line 76
    ...
    def serr_sigma_mapping(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_setup.f90 line 77
    ...
    def dt(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_setup.f90 line 78
    ...
    def start_time(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_setup.f90 line 79
    ...
    def snow_directory(self):
        """
        Element snow_directory ftype=character(lchar) pytype=str
    ...
    def temp_directory(self):
        """
        Element temp_directory ftype=character(lchar) pytype=str
...
def setupdt_copy(self):
    ...
    Defined at ../smash/fcore/derived_type/mwd_setup.f90 lines 134-138
    ...
    """
    this_copy = _libfcore.f90wrap_setupdt_copy(this=self._handle)
    this_copy = \
