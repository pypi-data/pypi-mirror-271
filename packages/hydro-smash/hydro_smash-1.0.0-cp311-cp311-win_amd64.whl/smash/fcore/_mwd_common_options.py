...
class Common_OptionsDT(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, handle=None):
        ...
        result = _libfcore.f90wrap_common_optionsdt_initialise()
    ...
    def __del__(self):
        ...
        try:
            if self._alloc:
                _libfcore.f90wrap_common_optionsdt_finalise(this=self._handle)
        except:
            pass
...
def common_optionsdt_copy(self):
    ...
    """
    this_copy = _libfcore.f90wrap_common_optionsdt_copy(this=self._handle)
    this_copy = \
