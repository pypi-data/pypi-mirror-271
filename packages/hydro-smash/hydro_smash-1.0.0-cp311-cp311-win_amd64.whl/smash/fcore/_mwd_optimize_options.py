...
Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 lines 40-104
...
class Optimize_OptionsDT(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 lines 44-64
    ...
    def __init__(self, setup, handle=None):
        ...
        Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 lines 67-98
        ...
        result = _libfcore.f90wrap_optimize_optionsdt_initialise(setup=setup._handle)
    ...
    def __del__(self):
        ...
        try:
            if self._alloc:
                _libfcore.f90wrap_optimize_optionsdt_finalise(this=self._handle)
        except:
            pass
...
def optimize_optionsdt_copy(self):
    ...
    Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 lines 100-104
    ...
    """
    this_copy = _libfcore.f90wrap_optimize_optionsdt_copy(this=self._handle)
    this_copy = \
