...
def get_flwdst_cls(flwdst, flwdst_cls):
    ...
    """
    _libfcore.f90wrap_get_flwdst_cls(flwdst=flwdst, flwdst_cls=flwdst_cls)
...
def get_width_function_cdf(flwdst, flwdst_cls, w_cdf):
    ...
    """
    _libfcore.f90wrap_get_width_function_cdf(flwdst=flwdst, flwdst_cls=flwdst_cls, \
        w_cdf=w_cdf)
...
def get_rainfall_weighted_width_function_cdf(flwdst, flwdst_cls, prcp_matrix, \
    ...
    """
    _libfcore.f90wrap_get_rainfall_weighted_width_function_cdf(flwdst=flwdst, \
...
def precipitation_indices_computation(self, mesh, input_data, prcp_indices):
    ...
    """
    _libfcore.f90wrap_precipitation_indices_computation(setup=self._handle, \
