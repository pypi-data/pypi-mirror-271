...
Defined at ../smash/fcore/derived_type/mwd_returns.f90 lines 47-150
...
class ReturnsDT(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at ../smash/fcore/derived_type/mwd_returns.f90 lines 53-82
    ...
    def __init__(self, setup, mesh, nmts, keys, handle=None):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 lines 85-144
        ...
        result = _libfcore.f90wrap_returnsdt_initialise(setup=setup._handle, \
    ...
    def __del__(self):
        ...
        try:
            if self._alloc:
                _libfcore.f90wrap_returnsdt_finalise(this=self._handle)
        except:
            pass
    ...
    def iter_cost(self):
        """
        Element iter_cost ftype=real(sp) pytype=float
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _libfcore.f90wrap_returnsdt__array__iter_cost(self._handle)
        if array_handle in self._arrays:
            iter_cost = self._arrays[array_handle]
        else:
            iter_cost = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _libfcore.f90wrap_returnsdt__array__iter_cost)
            self._arrays[array_handle] = iter_cost
        return iter_cost
    
    @iter_cost.setter
    def iter_cost(self, iter_cost):
        self.iter_cost[...] = iter_cost
    
    @property
    def iter_cost_flag(self):
        """
        Element iter_cost_flag ftype=logical pytype=bool
        
        
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 62
        
        """
        return _libfcore.f90wrap_returnsdt__get__iter_cost_flag(self._handle)
    
    @iter_cost_flag.setter
    def iter_cost_flag(self, iter_cost_flag):
        _libfcore.f90wrap_returnsdt__set__iter_cost_flag(self._handle, iter_cost_flag)
    
    @property
    def iter_projg(self):
        """
        Element iter_projg ftype=real(sp) pytype=float
        ...
        """
        array_ndim, array_type, array_shape, array_handle = \
            _libfcore.f90wrap_returnsdt__array__iter_projg(self._handle)
        if array_handle in self._arrays:
            iter_projg = self._arrays[array_handle]
        else:
            iter_projg = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _libfcore.f90wrap_returnsdt__array__iter_projg)
            self._arrays[array_handle] = iter_projg
        return iter_projg
    
    @iter_projg.setter
    def iter_projg(self, iter_projg):
        self.iter_projg[...] = iter_projg
    
    @property
    def iter_projg_flag(self):
        """
        Element iter_projg_flag ftype=logical pytype=bool
        
        
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 64
        
        """
        return _libfcore.f90wrap_returnsdt__get__iter_projg_flag(self._handle)
    
    @iter_projg_flag.setter
    def iter_projg_flag(self, iter_projg_flag):
        _libfcore.f90wrap_returnsdt__set__iter_projg_flag(self._handle, iter_projg_flag)
    
    @property
    def control_vector(self):
        """
        Element control_vector ftype=real(sp) pytype=float
        
        
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 65
        
        """
        array_ndim, array_type, array_shape, array_handle = \
            _libfcore.f90wrap_returnsdt__array__control_vector(self._handle)
        if array_handle in self._arrays:
            control_vector = self._arrays[array_handle]
        else:
            control_vector = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _libfcore.f90wrap_returnsdt__array__control_vector)
            self._arrays[array_handle] = control_vector
        return control_vector
    
    @control_vector.setter
    def control_vector(self, control_vector):
        self.control_vector[...] = control_vector
    
    @property
    def control_vector_flag(self):
        """
        Element control_vector_flag ftype=logical pytype=bool
        
        
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 66
        
        """
        return _libfcore.f90wrap_returnsdt__get__control_vector_flag(self._handle)
    
    @control_vector_flag.setter
    def control_vector_flag(self, control_vector_flag):
        _libfcore.f90wrap_returnsdt__set__control_vector_flag(self._handle, \
            control_vector_flag)
    ...
    def cost(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 67
    ...
    def cost_flag(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 68
    ...
    def jobs(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 69
    ...
    def jobs_flag(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 70
    ...
    def jreg(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 71
    ...
    def jreg_flag(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 72
    ...
    def log_lkh(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 73
    ...
    def log_lkh_flag(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 74
    ...
    def log_prior(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 75
    ...
    def log_prior_flag(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 76
    ...
    def log_h(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 77
    ...
    def log_h_flag(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 78
    ...
    def serr_mu(self):
        """
        Element serr_mu ftype=real(sp) pytype=float
        
        
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 79
        
        """
        array_ndim, array_type, array_shape, array_handle = \
            _libfcore.f90wrap_returnsdt__array__serr_mu(self._handle)
        if array_handle in self._arrays:
            serr_mu = self._arrays[array_handle]
        else:
            serr_mu = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _libfcore.f90wrap_returnsdt__array__serr_mu)
            self._arrays[array_handle] = serr_mu
        return serr_mu
    
    @serr_mu.setter
    def serr_mu(self, serr_mu):
        self.serr_mu[...] = serr_mu
    
    @property
    def serr_mu_flag(self):
        """
        Element serr_mu_flag ftype=logical pytype=bool
        
        
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 80
        
        """
        return _libfcore.f90wrap_returnsdt__get__serr_mu_flag(self._handle)
    
    @serr_mu_flag.setter
    def serr_mu_flag(self, serr_mu_flag):
        _libfcore.f90wrap_returnsdt__set__serr_mu_flag(self._handle, serr_mu_flag)
    
    @property
    def serr_sigma(self):
        """
        Element serr_sigma ftype=real(sp) pytype=float
        
        
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 81
        
        """
        array_ndim, array_type, array_shape, array_handle = \
            _libfcore.f90wrap_returnsdt__array__serr_sigma(self._handle)
        if array_handle in self._arrays:
            serr_sigma = self._arrays[array_handle]
        else:
            serr_sigma = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    self._handle,
                                    _libfcore.f90wrap_returnsdt__array__serr_sigma)
            self._arrays[array_handle] = serr_sigma
        return serr_sigma
    
    @serr_sigma.setter
    def serr_sigma(self, serr_sigma):
        self.serr_sigma[...] = serr_sigma
    
    @property
    def serr_sigma_flag(self):
        """
        Element serr_sigma_flag ftype=logical pytype=bool
        
        
        Defined at ../smash/fcore/derived_type/mwd_returns.f90 line 82
        
        """
        return _libfcore.f90wrap_returnsdt__get__serr_sigma_flag(self._handle)
    
    @serr_sigma_flag.setter
    def serr_sigma_flag(self, serr_sigma_flag):
        _libfcore.f90wrap_returnsdt__set__serr_sigma_flag(self._handle, serr_sigma_flag)
...
def returnsdt_copy(self):
    ...
    Defined at ../smash/fcore/derived_type/mwd_returns.f90 lines 146-150
    ...
    """
    this_copy = _libfcore.f90wrap_returnsdt_copy(this=self._handle)
    this_copy = \
