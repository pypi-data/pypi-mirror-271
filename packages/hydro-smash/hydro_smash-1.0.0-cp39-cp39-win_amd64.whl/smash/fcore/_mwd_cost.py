...
Defined at ../smash/fcore/optimize/mwd_cost.f90 lines 16-403
...
def get_range_event(mask_event, i_event):
    ...
    Defined at ../smash/fcore/optimize/mwd_cost.f90 lines 32-50
    ...
    only: ReturnsDT
    """
    res = _libfcore.f90wrap_get_range_event(mask_event=mask_event, i_event=i_event)
    return res
...
def discharge_tranformation(tfm, qo, qs):
    ...
    Defined at ../smash/fcore/optimize/mwd_cost.f90 lines 52-70
    ...
    """
    _libfcore.f90wrap_discharge_tranformation(tfm=tfm, qo=qo, qs=qs)
...
def bayesian_compute_cost(self, mesh, input_data, parameters, output, options, \
    ...
    Defined at ../smash/fcore/optimize/mwd_cost.f90 lines 72-127
    ...
    """
    _libfcore.f90wrap_bayesian_compute_cost(setup=self._handle, mesh=mesh._handle, \
...
def classical_compute_jobs(self, mesh, input_data, output, options, jobs):
    ...
    Defined at ../smash/fcore/optimize/mwd_cost.f90 lines 129-339
    ...
    """
    _libfcore.f90wrap_classical_compute_jobs(setup=self._handle, mesh=mesh._handle, \
...
def classical_compute_jreg(self, mesh, input_data, parameters, options, jreg):
    ...
    Defined at ../smash/fcore/optimize/mwd_cost.f90 lines 341-367
    ...
    """
    _libfcore.f90wrap_classical_compute_jreg(setup=self._handle, mesh=mesh._handle, \
        input_data=input_data._handle, parameters=parameters._handle, \
        options=options._handle, jreg=jreg)
...
def classical_compute_cost(self, mesh, input_data, parameters, output, options, \
    ...
    Defined at ../smash/fcore/optimize/mwd_cost.f90 lines 369-388
    ...
    """
    _libfcore.f90wrap_classical_compute_cost(setup=self._handle, mesh=mesh._handle, \
        input_data=input_data._handle, parameters=parameters._handle, \
        output=output._handle, options=options._handle, returns=returns._handle)
...
def compute_cost(self, mesh, input_data, parameters, output, options, returns):
    ...
    Defined at ../smash/fcore/optimize/mwd_cost.f90 lines 390-403
    ...
    """
    _libfcore.f90wrap_compute_cost(setup=self._handle, mesh=mesh._handle, \
        input_data=input_data._handle, parameters=parameters._handle, \
        output=output._handle, options=options._handle, returns=returns._handle)
