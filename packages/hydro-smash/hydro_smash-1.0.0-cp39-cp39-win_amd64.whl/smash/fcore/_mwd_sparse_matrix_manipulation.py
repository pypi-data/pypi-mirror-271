...
def binary_search(n, vector, vle, ind):
    ...
    """
    _libfcore.f90wrap_binary_search(n=n, vector=vector, vle=vle, ind=ind)
...
def compute_rowcol_to_ind_ac(self):
    ...
    -----
    """
    _libfcore.f90wrap_compute_rowcol_to_ind_ac(mesh=self._handle)
...
def matrix_to_ac_vector(self, matrix, ac_vector):
    ...
    """
    _libfcore.f90wrap_matrix_to_ac_vector(mesh=self._handle, matrix=matrix, \
        ac_vector=ac_vector)
...
def ac_vector_to_matrix(self, ac_vector, matrix):
    ...
    """
    _libfcore.f90wrap_ac_vector_to_matrix(mesh=self._handle, ac_vector=ac_vector, \
        matrix=matrix)
...
def get_matrix_nnz(self, matrix, zvalue, nnz):
    ...
    """
    _libfcore.f90wrap_get_matrix_nnz(mesh=self._handle, matrix=matrix, \
        zvalue=zvalue, nnz=nnz)
...
def coo_fill_sparse_matrix(self, matrix, sparse_matrix):
    ...
    """
    _libfcore.f90wrap_coo_fill_sparse_matrix(mesh=self._handle, matrix=matrix, \
        sparse_matrix=sparse_matrix._handle)
...
def ac_fill_sparse_matrix(self, matrix, sparse_matrix):
    ...
    """
    _libfcore.f90wrap_ac_fill_sparse_matrix(mesh=self._handle, matrix=matrix, \
        sparse_matrix=sparse_matrix._handle)
...
def fill_sparse_matrix(self, matrix, sparse_matrix):
    ...
    """
    _libfcore.f90wrap_fill_sparse_matrix(mesh=self._handle, matrix=matrix, \
        sparse_matrix=sparse_matrix._handle)
...
def matrix_to_sparse_matrix(self, matrix, zvalue, sparse_matrix):
    ...
    """
    _libfcore.f90wrap_matrix_to_sparse_matrix(mesh=self._handle, matrix=matrix, \
        zvalue=zvalue, sparse_matrix=sparse_matrix._handle)
...
def coo_sparse_matrix_to_matrix(self, sparse_matrix, matrix):
    ...
    """
    _libfcore.f90wrap_coo_sparse_matrix_to_matrix(mesh=self._handle, \
...
def ac_sparse_matrix_to_matrix(self, sparse_matrix, matrix):
    ...
    """
    _libfcore.f90wrap_ac_sparse_matrix_to_matrix(mesh=self._handle, \
        sparse_matrix=sparse_matrix._handle, matrix=matrix)
...
def sparse_matrix_to_matrix(self, sparse_matrix, matrix):
    ...
    """
    _libfcore.f90wrap_sparse_matrix_to_matrix(mesh=self._handle, \
        sparse_matrix=sparse_matrix._handle, matrix=matrix)
...
def coo_get_sparse_matrix_dat(self, row, col, sparse_matrix, res):
    ...
    """
    _libfcore.f90wrap_coo_get_sparse_matrix_dat(mesh=self._handle, row=row, col=col, \
        sparse_matrix=sparse_matrix._handle, res=res)
...
def ac_get_sparse_matrix_dat(self, row, col, sparse_matrix, res):
    ...
    """
    _libfcore.f90wrap_ac_get_sparse_matrix_dat(mesh=self._handle, row=row, col=col, \
        sparse_matrix=sparse_matrix._handle, res=res)
...
def get_sparse_matrix_dat(self, row, col, sparse_matrix, res):
    ...
    """
    _libfcore.f90wrap_get_sparse_matrix_dat(mesh=self._handle, row=row, col=col, \
        sparse_matrix=sparse_matrix._handle, res=res)
