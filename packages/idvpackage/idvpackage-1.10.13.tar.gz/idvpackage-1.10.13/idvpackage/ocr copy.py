...
#                         video_quality['error'] = 'no_face_detected_in_video'
    ...
    def extract_face_and_compute_similarity(self, selfie, front_face_locations, front_face_encodings):
        ...
        print(f"F1: {len(face_encodings1)}")
        print(f"F2: {len(face_encodings2)}")
        ...
        if not face_encodings1 or not face_encodings2:
            ...
            image_path = '/Users/fahadpatel/Downloads/national_id_1k/national_id-2/949a4d51-94d2-4fd8-8e7b-fe477bd45c8c.jpg'
            image = Image.open(image_path)
            draw = ImageDraw.Draw(image)
            for face_location in face_locations1 + face_locations2:
                top, right, bottom, left = face_location
                draw.rectangle(((left, top), (right, bottom)), outline="red", width=3)
            
            save_path = '/Users/fahadpatel/Downloads/highlighted_faces.jpg'  # Set the path where you want to save the image
        ...
        if country == 'IRQ':
            ...
            if is_colored2:
                try:
                    ...
                    file_path = '/Users/fahadpatel/Downloads/image_name.png'
