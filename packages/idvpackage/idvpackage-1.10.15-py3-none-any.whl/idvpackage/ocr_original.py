...
#                         video_quality['error'] = 'no_face_detected_in_video'
    ...
    def check_for_liveness(self, similarity, video_bytes, face_match_threshold=0.2):
        with tempfile.NamedTemporaryFile(delete=False) as temp_video_file:
            temp_video_file.write(video_bytes)
    ...
    def extract_ocr_info(self, data, video, country, report_names, face_match_threshold=0.20):
        document_report = {}
        facial_report = {}
