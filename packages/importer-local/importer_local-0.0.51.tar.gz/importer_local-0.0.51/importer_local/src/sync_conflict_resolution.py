...
class SyncConflictResolution(GenericCRUD):
    ...
    def get_update_status(self, last_modified_timestamp: str, data_source_id: int, entity_type_id: int,
        ...
        updated_timestamp: str = self.select_one_value_by_where(
        ...
        updated_timestamp: datetime = datetime.strptime(updated_timestamp, '%Y-%m-%d %H:%M:%S') if updated_timestamp else None
