...
class Completions(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        end_id: Optional[int] | NotGiven = NOT_GIVEN,
        stop: Union[Optional[str], List[str]] | NotGiven = NOT_GIVEN,
        return_generation_logits: Optional[bool] | NotGiven = NOT_GIVEN,
        logits_top_k: Optional[int] | NotGiven = NOT_GIVEN,
        ...
        Args:
          ...
          frequency_penalty: Number between -2.0 and 2.0. Positive values penalize new tokens based on their
              ...
              [See more information about frequency and presence penalties.](https://platform.aiplatform.com/docs/guides/text-generation/parameter-details)
          ...
          response_format: An object specifying the format that the model must output. Compatible with
              [GPT-4 Turbo](https://platform.aiplatform.com/docs/models/gpt-4-and-gpt-4-turbo) and
          ...
          user: A unique identifier representing your end-user, which can help AIPlatform to monitor
              and detect abuse.
              [Learn more](https://platform.aiplatform.com/docs/guides/safety-best-practices/end-user-ids).
