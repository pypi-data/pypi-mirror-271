...
from kywy.client.layout_builder import KawaChartBuilder
...
class KawaColumn:
    ...
    def time_range(self,
                   from_inclusive: typing.Optional[datetime.time] = None,
                   from_exclusive: typing.Optional[datetime.time] = None,
                   to_inclusive: typing.Optional[datetime.time] = None,
                   to_exclusive: typing.Optional[datetime.time] = None):
