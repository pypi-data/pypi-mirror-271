NestedDict = {
    ...
    "company_desc_tags": {},
    "company_diy_tags": {},
    "company_ent_score_tags": {
        "score_tag": "(total_point Float32, innovative_ability Float32, financing_ability Float32, operating_ability Float32, competitive_strength Float32, credit_risk Int32)"
    },
    ...
    "company_market_latest_tags": {
        "market_tag": "(stock_short String, stock_code String, status String, market_date Nullable(Date32), block String, block_detail String)"
    },
    "company_operating_risk_tags": {
        "operating_risk": "(risk_status String, risk_type Array(String), risk_date Array(String))"
    },
    ...
    "company_risk_tags": {
        "risk": "(type Enum8('NULL' = 0, '\u884c\u653f\u5904\u7f5a' = 1, '\u7ecf\u8425\u5f02\u5e38' = 2, '\u4e25\u91cd\u8fdd\u6cd5' = 3, '\u62bd\u67e5\u4e0d\u5408\u683c' = 4, '\u6ce8\u8d44\u51cf\u5c11' = 5, '\u52a8\u4ea7\u62b5\u62bc' = 6, '\u80a1\u6743\u51fa\u8d28' = 7, '\u4f01\u4e1a\u51b3\u8bae\u89e3\u6563/\u88ab\u540a\u9500\u8425\u4e1a\u6267\u7167' = 8, '\u6e05\u7b97\u7ec4\u4fe1\u606f' = 9, '\u77e5\u8bc6\u4ea7\u6743\u51fa\u8d28' = 10, '\u7b80\u6613\u6ce8\u9500\u516c\u544a' = 11, '\u5bf9\u5916\u62c5\u4fdd' = 12, '\u80a1\u6743\u8d28\u62bc' = 13), date Nullable(Date32), is_history Nullable(Int8))"
    },
    "company_score_tags": {},
    ...
    "league_location_tags": {
        "location": "(reg_province String, reg_city String, reg_district String, reg_geo_wgs84 Point)"
    },
