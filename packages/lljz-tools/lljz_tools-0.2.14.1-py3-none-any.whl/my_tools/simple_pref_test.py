...
class PrefRunner:
    ...
    def start(self, *args, test_name='性能测试', **kwargs, ):
        ...
        try:
            ...
            print('\n' + end_str)
            self._save(test_name, table_data, tps, response)

    def _save_html(self, test_name, file, table, tps, response):
    ...
    def _save(self, test_name, table, tps, response):
        ...
        self._save_html(test_name, file + '.html', table, tps, response)
