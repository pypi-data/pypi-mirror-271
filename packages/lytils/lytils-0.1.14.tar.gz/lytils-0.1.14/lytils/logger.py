...
class LyLogger:
    ...
    def __init__(
        ...
        Args:
            ...
            path (str): The default path of the log file(s).
            ...
            level (str): The level of the threshold of logs that will be taken. Least to most: debug > info > warning > error > critical.
        ...
        self.debug_path = debug_path if debug_path else path
        self.info_path = info_path if info_path else path
        self.warning_path = warning_path if warning_path else path
        self.error_path = error_path if error_path else path
        self.critical_path = critical_path if critical_path else path
    ...
    def setup(self, persistent: bool = False) -> None:
        ...
        """
        log_file = LyFile(self.path)

        # Create file if it should be overwritten or if it doesn't exist.
