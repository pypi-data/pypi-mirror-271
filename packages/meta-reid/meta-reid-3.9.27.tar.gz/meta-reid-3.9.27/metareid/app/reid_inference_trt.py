...
class ReidInferenceTrt:
    ...
    def save_features(self):
        np.save(self.query_image_path.replace('.npy', '_tmp.npy'), self.query_images)
        os.replace(self.query_image_path.replace('.npy', '_tmp.npy'), self.query_image_path)
        np.save(self.query_file_path.replace('.npy', '_tmp.npy'), self.query_files)
        os.replace(self.query_file_path.replace('.npy', '_tmp.npy'), self.query_file_path)
        np.save(self.query_name_path.replace('.npy', '_tmp.npy'), self.query_names)
        os.replace(self.query_name_path.replace('.npy', '_tmp.npy'), self.query_name_path)
        np.save(self.query_feature_path.replace('.npy', '_tmp.npy'), self.query_features)
        os.replace(self.query_feature_path.replace('.npy', '_tmp.npy'), self.query_feature_path)
