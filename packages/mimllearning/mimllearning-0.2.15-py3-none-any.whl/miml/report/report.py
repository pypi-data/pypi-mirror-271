import pandas as pd
from sklearn.metrics import classification_report, hamming_loss, accuracy_score, fbeta_score, jaccard_score, log_loss, \
...
class Report:
    ...
    def calculate_metrics(self, y_true, y_pred):
        self.metrics_value["precision-score-macro"] = precision_score(y_true, y_pred, average="macro")
        self.metrics_value["precision-score-micro"] = precision_score(y_true, y_pred, average="micro")
        self.metrics_value["average-precision-score-macro"] = precision_score(y_true, y_pred, average="macro")
        self.metrics_value["average-precision-score-micro"] = precision_score(y_true, y_pred, average="micro")
        self.metrics_value["recall-score-macro"] = recall_score(y_true, y_pred, average="macro")
        self.metrics_value["recall-score-micro"] = recall_score(y_true, y_pred, average="micro")
        self.metrics_value["f1-score-macro"] = f1_score(y_true, y_pred, average="macro")
        self.metrics_value["f1-score-micro"] = f1_score(y_true, y_pred, average="micro")
        self.metrics_value["fbeta-score-macro"] = fbeta_score(y_true, y_pred, average="macro")
        self.metrics_value["fbeta-score-micro"] = fbeta_score(y_true, y_pred, average="micro")
        ...
        self.metrics_value["jaccard-score"] = jaccard_score(y_true, y_pred)
        ...
        if self.per_label:
            ...
            self.metrics_value["fbeta-score-per-label"] = fbeta_score(y_true, y_pred, average="None")
