...
class Report:
    ...
    def __init__(self, metrics=None, header=True, per_label=False):
        ...
        all_metrics = ["precision-score-macro", "precision-score-micro", "average-precision-score-macro",
                       ...
                       "roc-auc-score-micro", "accuracy-score", "hamming-loss", "jaccard-score-macro", 
                       "jaccard-score-micro", "log-loss"]
        '''
        all_metrics = ["precision-score-macro", "precision-score-micro", "recall-score-macro", "recall-score-micro",
                       "f1-score-macro", "f1-score-micro", "fbeta-score-macro", "fbeta-score-micro", "accuracy-score",
                       "hamming-loss", "jaccard-score-macro", "jaccard-score-micro"]
        if per_label:
            all_metrics += ["recall-score-per-label", "f1-score-per-label",
