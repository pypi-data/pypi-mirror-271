...
# Example usage:
# Assuming `ds` is your TensorFlow dataset object
# train_dataset = prepare_dataset(ds, batch_size=32, shuffle=True, num_parallel_calls=4, distributed=False)
...
# tf_dataset = TF_XrDataset(ds, num_chunks=100, rand_chunk=True, drop_nan=True, filter_var='land_mask')
# dataset = tf_dataset.get_dataset()
# for sample in dataset:
#     print(sample)  # Process your sample here
