...
def load_yolo_model(model_path=default_model_path):
  """
  Loads the YOLO model from the package directory.
  """
  # Get the absolute path to the model file within the package
  model_file = resource_filename(__name__, model_path)
