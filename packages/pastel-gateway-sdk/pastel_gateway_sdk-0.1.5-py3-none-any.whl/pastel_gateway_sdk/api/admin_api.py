...
class AdminApi:
    ...
    @validate_call
    async def create_client_api_v1_admin_create_client_post(
        self,
        ...
        _param = self._create_client_api_v1_admin_create_client_post_serialize(
    ...
    @validate_call
    async def create_client_api_v1_admin_create_client_post_with_http_info(
        self,
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
                                Tuple[Annotated[StrictFloat,
    ...
    @validate_call
    async def create_client_api_v1_admin_create_client_post_without_preload_content(
        self,
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
                                Tuple[Annotated[StrictFloat,
    ...
    def _create_client_api_v1_admin_create_client_post_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/admin/create_client',
