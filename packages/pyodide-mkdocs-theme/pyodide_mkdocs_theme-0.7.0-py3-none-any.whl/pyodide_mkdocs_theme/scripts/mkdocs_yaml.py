...
# Nécessite mkdocs 1.6+ pour fonctionner correctement. Sinon, vous pouvez utiliser
# le plugin mkdocs-exclude à la place.
# Ne surtout pas mettre de commentaires sur la ligne d'exclusion des fichiers python... !
# (la dernière ligne: projets pour plus tard...)
exclude_docs: |
  **/*_REM.md
  **/*.py
  !/py_libs/*.py
...
plugins:
  ...
  - material/search         # !!REQUIS!! / Nota: Les plugins de material-mkdocs doivent être préfixés!
