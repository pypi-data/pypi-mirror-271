...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int = 0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.8.0 fwBuild=25/04/2024-12:15:46 fwHash=0x8DBAB355 fwDirty=0 kmodVersion=0.8.0 kmodBuild=24/04/2024-16:23:01 kmodHash=0x3462F858 kmodDirty=0 swVersion=0.8.0 swBuild=24/04/2024-16:23:01 swHash=0x3462F858 swDirty=0 cfgManVersion=0.3.0 cfgManBuild=24/04/2024-16:23:01 cfgManHash=0x3462F858 cfgManDirty=0"
            if build != build_ref:
                ...
                raise ConnectionError(
                    ...
                    + "\n"
                    + f"                        {'Expected:':<25} Actual:\n"
                    + f"Firmware;      Version: {build_ref[1]:<25} {build[1]}\n"
                    + f"               Date:    {build_ref[3]:<25} {build[3]}\n"
                    + f"               Hash:    {build_ref[5]:<25} {build[5]}\n"
                    + f"               Dirty:   {build_ref[7]:<25} {build[7]}\n"
                    + f"Kernel module; Version: {build_ref[9]:<25} {build[9]}\n"
                    + f"               Date:    {build_ref[11]:<25} {build[11]}\n"
                    + f"               Hash:    {build_ref[13]:<25} {build[13]}\n"
                    + f"               Dirty:   {build_ref[15]:<25} {build[15]}\n"
                    + f"Application;   Version: {build_ref[17]:<25} {build[17]}\n"
                    + f"               Date:    {build_ref[19]:<25} {build[19]}\n"
                    + f"               Hash:    {build_ref[21]:<25} {build[21]}\n"
                    + f"               Dirty:   {build_ref[23]:<25} {build[23]}\n"
                    + "\n"
    ...
    def _set_quad_config(self, slot: int, quad: int, quad_config: Any) -> None:
        ...
        # SCPI call
        self._write_bin(
            f"SLOT{slot}:QUAD{quad}:CONFig ",
            json.dumps(quad_config).encode("utf-8"),
        )
    ...
    def _set_sequencer_program(self, slot: int, sequencer: int, program: str) -> None:
        ...
        # SCPI call
        self._write_bin(
            f"SLOT{slot}:SEQuencer{sequencer}:PROGram ",
