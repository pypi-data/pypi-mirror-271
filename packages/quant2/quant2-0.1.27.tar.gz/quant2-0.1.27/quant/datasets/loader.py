...
def _construct_loader(dataset_name, data_path, split, fixed, batch_size, shuffle, drop_last):
    """Constructs the data loader for the given dataset."""
    err_str = "Dataset '{}' not supported".format(dataset_name)
    assert dataset_name in _DATASETS, err_str
    # Construct the dataset
    dataset = _DATASETS[dataset_name](data_path, split, fixed)
...
def _construct_loader_ffcv(dataset_name, data_path, split, fixed, batch_size, shuffle, drop_last):
