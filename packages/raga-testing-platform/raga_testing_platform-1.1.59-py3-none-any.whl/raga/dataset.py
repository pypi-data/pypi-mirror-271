...
class CocoDataset(Dataset):
    ...
    def __init__(self, test_session: TestSession, name: str, type: Optional[str],
                 ...
                 aws_session_token: Optional[str] = None, inherited_class = None):
...
class ODDataset(Dataset):
    ...
    def __init__(self, test_session: TestSession, name: str, type: Optional[str],
        ...
        super(ODDataset, self).__init__(test_session=test_session, name=name, type=DATASET_TYPE.IMAGE, data=pd_data_frame, schema=schema)
...
class ICDataset(Dataset):
    ...
    def __init__(self, test_session: TestSession, name: str, type: Optional[str],
        ...
        super(ICDataset, self).__init__(test_session=test_session, name=name, type=DATASET_TYPE.IMAGE, data=pd_data_frame, schema=schema)
...
class KDataset(Dataset):
    ...
    def __init__(self, test_session: TestSession, name: str, type: Optional[str],
                 ...
                 aws_session_token: Optional[str] = None, parent_dataset_name:Optional[str]=None, image_folder_path:Optional[str]=None):
        self.json_file_path = json_file_path
        self.image_folder_path = image_folder_path
        self.label_map = label_map
        ...
        super(KDataset, self).__init__(test_session=test_session, name=name, type=DATASET_TYPE.IMAGE, data=self.pd_data_frame, schema=schema, parent_dataset=parent_dataset_name)
