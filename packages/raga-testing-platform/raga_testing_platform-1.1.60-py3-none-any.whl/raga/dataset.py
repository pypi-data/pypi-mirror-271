...
class ODDataset(Dataset):
    ...
    def __init__(self, test_session: TestSession, name: str, type: Optional[str],
        ...
        if bucket_region is not None :
            cred = DatasetCreds(region=bucket_region)
        super(ODDataset, self).__init__(test_session=test_session, name=name, type=DATASET_TYPE.IMAGE, data=pd_data_frame, schema=schema, creds=cred)
...
class ICDataset(Dataset):
    ...
    def __init__(self, test_session: TestSession, name: str, type: Optional[str],
        ...
        if bucket_region is not None :
            cred = DatasetCreds(region=bucket_region)
        super(ICDataset, self).__init__(test_session=test_session, name=name, type=DATASET_TYPE.IMAGE, data=pd_data_frame, schema=schema, creds=cred)
