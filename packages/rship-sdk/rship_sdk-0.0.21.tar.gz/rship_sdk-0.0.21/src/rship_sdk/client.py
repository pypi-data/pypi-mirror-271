...
from .models import Target, Action, Emitter, Pulse, Instance, Service, Machine, Alert, InstanceStatus, TargetStatus, AlertEntityType, AlertLevel
from .utils import generate_id, get_current_timestamp, make_instance_id

class RshipExecClient:
    def __init__(self, rship_host: str, rship_port: int, is_connected: bool):
    ...
    async def save_service(self, service: Service):
        self.services[service.id] = service
        await self.set_data(service, 'Service')
