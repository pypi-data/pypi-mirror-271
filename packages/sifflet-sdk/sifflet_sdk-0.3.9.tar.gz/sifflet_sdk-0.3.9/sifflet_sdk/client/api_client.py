...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.sql_query_correction  # this is an instance of the class Endpoint
        api_instance.sql_query_correction()  # this invokes api_instance.sql_query_correction.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.sql_query_correction.callable or self.callable in this class
