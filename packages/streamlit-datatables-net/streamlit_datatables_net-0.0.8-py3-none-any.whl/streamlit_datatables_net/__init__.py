...
def streamlit_datatable(props: Dict, table_id: str = None, class_name: str = None, stylesheets: List[str] = None, key=None):
    """Create a new instance of "streamlit_datatable".
...
if not _RELEASE:
    ...
    columns = [
        ...
        {"data": "salary", "title": "Salary",
            "render": ['number', ',', '.', 0, '$']},
        {"data": "", "title": "Actions",
            "column_type": "actions", "actions": ["review", "edit", "delete", "pdf"]},
    ...
    with col_m:
        dt_response = streamlit_datatable(
            props, table_id="my_datatable", class_name=class_name, stylesheets=stylesheets, key="bar")
