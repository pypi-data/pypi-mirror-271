...
class AsyncApiClient:
    """AsyncApiClient is the main wrapper for the Discovery API via asynchronous operation.
    ...
    async def search(self, method, **kwargs):
        ...
        for k, v in kwargs.items():
            if k in ['includeTBA', 'includeTBD', 'includeTest', 'includeFamily', 'includeSpellcheck']:
...
class ApiException(Exception):
    """Exception thrown for API error messages"""
