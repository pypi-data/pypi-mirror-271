...
class BaseQuery:
    ...
    attr_map = {
        ...
        'dma_id': 'dmaId',
        'local_start_date_time': 'localStartDateTime',
        'local_start_end_date_time': 'localStartEndDateTime',
        'start_end_date_time': 'startEndDateTime',
        'public_visibility_start_date_time': 'publicVisibilityStartDateTime',
        'presale_date_time': 'preSaleDateTime',
        'onsale_on_start_date': 'onsaleOnStartDate',
        'onsale_on_after_start_date': 'onsaleOnAfterStartDate',
        ...
        'include_spell_check': 'includeSpellCheck',
        'domain': 'domain',
