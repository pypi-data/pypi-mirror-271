...
class amazon():
    ...
    @staticmethod
    def check_holiday(self, date_obj, con, which='NYSE_Holiday'):
    ...
    @staticmethod
    def data_pull(self, sql_query, con, indicator):
    ...
    @staticmethod
    def sql_execute(self, sql_query, con, indicator):
    ...
    @staticmethod
    def insert_table(self, db_params, data, con, method, mode, dtype, schema = None, table=None):
        if schema is None:
