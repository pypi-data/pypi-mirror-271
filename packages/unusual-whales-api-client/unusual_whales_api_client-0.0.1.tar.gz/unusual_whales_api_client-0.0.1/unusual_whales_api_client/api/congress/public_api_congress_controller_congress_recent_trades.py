...
from ...models.senate_stock import SenateStock
...
) -> Optional[Union[ErrorMessage, SenateStock, str]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = SenateStock.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorMessage, SenateStock, str]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorMessage, SenateStock, str]
    """
