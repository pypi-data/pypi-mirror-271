...
T = TypeVar("T", bound="OptionContractScreenerResponse")


@_attrs_define
class OptionContractScreenerResponse:
    r"""
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        option_contract_screener_response = cls(
        ...
        option_contract_screener_response.additional_properties = d
        return option_contract_screener_response
