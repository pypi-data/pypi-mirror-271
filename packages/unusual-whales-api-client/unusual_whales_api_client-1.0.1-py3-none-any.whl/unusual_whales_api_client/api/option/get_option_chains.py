...
from ...models.option_chains_response import OptionChainsResponse
...
) -> Optional[Union[ErrorMessage, OptionChainsResponse, str]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = OptionChainsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorMessage, OptionChainsResponse, str]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorMessage, OptionChainsResponse, str]
    """
