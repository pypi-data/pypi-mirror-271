...
_lr_productions = [
  ...
  ('top -> expressions','top',1,'p_top','utillc.py',151),
  ('top -> EKON expressions','top',2,'p_top_1','utillc.py',155),
  ('top -> EKOX expressions','top',2,'p_top_2','utillc.py',158),
  ('top -> EKOT expressions','top',2,'p_top_3','utillc.py',162),
  ('expressions -> expression','expressions',1,'p_expressions_1','utillc.py',166),
  ('expressions -> expressions COMMA expression','expressions',3,'p_expressions_2','utillc.py',170),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','utillc.py',175),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','utillc.py',176),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','utillc.py',177),
  ('expression -> expression EQUALS expression','expression',3,'p_expression_binop','utillc.py',178),
  ('expression -> NAME ASSIGN expression','expression',3,'p_expression_binop','utillc.py',179),
  ('expression -> expression DIVIDE2 expression','expression',3,'p_expression_binop','utillc.py',180),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','utillc.py',181),
  ('name -> expression DOT dot_names','name',3,'p_expression_dot','utillc.py',185),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','utillc.py',189),
  ('expression -> LPAREN expressions RPAREN','expression',3,'p_expression_group','utillc.py',193),
  ('expression -> expression LBRACKET expressionsBE RBRACKET','expression',4,'p_expression_group','utillc.py',194),
  ('expression -> name LPAREN expressionsV RPAREN','expression',4,'p_expression_group','utillc.py',195),
  ('expression -> NUMBER','expression',1,'p_expression_number','utillc.py',205),
  ('expression -> FLOAT','expression',1,'p_expression_float','utillc.py',209),
  ('expression -> name','expression',1,'p_expression_name','utillc.py',213),
  ('expression -> STRING','expression',1,'p_expression_string','utillc.py',217),
  ('dot_names -> NAME','dot_names',1,'p_dot_names_1','utillc.py',221),
  ('expressionsBE -> <empty>','expressionsBE',0,'p_expressionsBE_1','utillc.py',230),
  ('expressionsBE -> expressionsBEE COMMA expressionsBE','expressionsBE',3,'p_expressionsBE_2','utillc.py',234),
  ('expressionsBE -> expressionsBEE','expressionsBE',1,'p_expressionsBE_3','utillc.py',238),
  ('expressionsBEE -> <empty>','expressionsBEE',0,'p_expressionsBEE_0','utillc.py',242),
  ('expressionsBEE -> expression','expressionsBEE',1,'p_expressionsBEE_1','utillc.py',245),
  ('expressionsBEE -> COLON','expressionsBEE',1,'p_expressionsBEE_2','utillc.py',248),
  ('expressionsBEE -> expression COLON expressionsBEE','expressionsBEE',3,'p_expressionsBEE_3','utillc.py',251),
  ('expressionsV -> <empty>','expressionsV',0,'p_expressionsV_1','utillc.py',256),
  ('expressionsV -> expressions','expressionsV',1,'p_expressionsV_2','utillc.py',260),
  ('name -> NAME','name',1,'p_name_1','utillc.py',268),
]
