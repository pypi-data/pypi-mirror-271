...
class MsgDeleteLimitParams(_message.Message):
    __slots__ = ("authority", "denom")
    AUTHORITY_FIELD_NUMBER: _ClassVar[int]
    DENOM_FIELD_NUMBER: _ClassVar[int]
    authority: str
    denom: str
    def __init__(self, authority: _Optional[str] = ..., denom: _Optional[str] = ...) -> None: ...

class MsgDeleteLimitParamsResponse(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
