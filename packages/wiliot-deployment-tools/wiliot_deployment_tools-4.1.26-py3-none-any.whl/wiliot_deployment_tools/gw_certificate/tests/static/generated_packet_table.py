...
class GeneratedPacketTable:
    ...
    def get_data(self, test, duplication, time_delay, bridge_idx) -> list:    
        ...
        assert (duplication in COUPLING_DUPLICATIONS) or (duplication in UPLINK_DUPLICATIONS), 'Invalid Duplication'
        assert (time_delay in COUPLING_TIME_DELAYS) or (time_delay in UPLINK_TIME_DELAYS), 'Invalid Time Delay'
