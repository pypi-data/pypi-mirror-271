...
<body>
    ...
    <script>
        ...
        tg.MainButton.onClick(async () => {
            ...
            console.log('fetch data to back: console.log(value, currency, period, minter, collection, addressOwnerRaw)')
            console.log(value, currency, period, minter, collection, addressOwnerRaw)
