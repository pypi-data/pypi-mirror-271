...
<body>
    <div class="container">
        <div class="header">
            <div class="subscribe-text"><a id="link" href="{0}">@ferey56666666666_bot</a>
            </div>
            <div id="connect"></div>
        </div>
        <div class="subscribe">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            document.getElementById("ft-link").href = `https://tonviewer.com/${{owner}}`;
            document.getElementById("nft-link").href = `https://tonviewer.com/${{owner}}`;

            document.getElementById("ft-link").addEventListener("click", async (event) => {{
                event.preventDefault()
                tg.openLink(`https://tonviewer.com/${{owner}}`, {{ try_instant_view: true }})
            }})
