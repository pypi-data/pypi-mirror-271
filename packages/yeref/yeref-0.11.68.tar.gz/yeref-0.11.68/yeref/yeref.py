        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            if (Object.keys(responseData).length > 0) {{
                ...
                if (responseData['USER_PAYDT'].includes('-')) {{
                    ...
                    document.getElementById('ft-send').style.color = '#666' 
                    document.getElementById('ft-send').style.opacity = '0.5'
                }}
                else {{
                    document.getElementById('ft-send').textContent = '{12} {4} {5}'
                    document.getElementById('ft-send').disabled = false
                    document.getElementById('ft-send').style.color = "var(--tg-theme-button-text-color)"
                    document.getElementById('ft-send').style.opacity = '1'
                }}
            }}
        }})
