...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {{            
            ...
            document.getElementById("address-collection-input-id").addEventListener("click", function() {{ navigator.clipboard.writeText(this.value) }})
            document.getElementById("address-minter-input-id").addEventListener("click", function() {{ navigator.clipboard.writeText(this.value) }})
...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            document.getElementById("nft-address").addEventListener("click", function() {{ navigator.clipboard.writeText(this.value) }})
