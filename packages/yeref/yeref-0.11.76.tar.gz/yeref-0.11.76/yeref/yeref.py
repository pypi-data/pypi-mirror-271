        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            if (Object.keys(upayinfo).length > 0) {{
                ...
                if (upayinfo['is_upaynft']) {{
                    document.getElementById('ft-get').textContent = '✔️ {15}'
                    document.getElementById('ft-get').disabled = true
                }}
                else {{
                    document.getElementById('ft-get').textContent = '{15}'
                    document.getElementById('ft-get').disabled = false
                }}
            }}
        }})
