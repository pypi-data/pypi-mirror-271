    ...
    <script>
        ...
        document.getElementById('nft-check').addEventListener('click', async () => {{
            ...
            if (nftAddress !== "") {{ 
                ...
                console.log('(get_nft_data['is_upaydt'] !== null)', (get_nft_data['is_upaydt'] !== null))
                console.log('get_nft_data['is_upaydt']', get_nft_data['is_upaydt'])
                
                upayinfo['is_upaynft'] = (get_nft_data['is_upaydt'] !== null) ? get_nft_data['is_upaydt'] : 0
                upayinfo['upaynft'] = (get_nft_data['is_upaydt'] !== null) ? get_nft_data['upaynft'] : ""
