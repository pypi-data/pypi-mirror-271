    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            if (Object.keys(upayinfo).length > 0) {{
                ...
                console.log(upayinfo['is_upaynft'])
        ...
        document.getElementById('nft-check').addEventListener('click', async () => {{
            ...
            if (nftAddress !== "") {{ 
                ...
                console.log('(get_nft_data['is_upaynft'] !== null)', (get_nft_data['is_upaynft'] !== null))
                console.log('get_nft_data['is_upaynft']', get_nft_data['is_upaynft'])
