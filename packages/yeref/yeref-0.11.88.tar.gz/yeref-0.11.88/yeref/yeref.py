...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {{            
            ...
            if (val !== 'TON') document.querySelector('.address-minter').style.display = 'flex'
            else document.querySelector('.address-minter').style.display = 'none'
